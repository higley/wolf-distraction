(function (root, factory) {
    ...
    templatizer["includes"]["howl"] = function tmpl_includes_howl() {
        return '<div class="well"><p data-hook="date"></p><p><a data-hook="link"></a></p><pre data-hook="content"></pre></div>';
    };

    // pages/home.jade compiled template
    templatizer["pages"]["home"] = function tmpl_pages_home() {
        return '<section class="page"><h1>Home!</h1></section>';
    };

    // pages/howls.jade compiled template
    templatizer["pages"]["howls"] = function tmpl_pages_howls() {
        return '<section class="page"><h1>Howls!</h1><textarea data-hook="howl-input"></textarea><p><button data-hook="action-howl" class="btn btn-primary">Howl</button></p><div data-hook="howls-container"> </div></section>';
    };
